...
export function PromptInputTextareaWithTypingAnimation() {
  ...
  return (
    <PromptInputTextarea ref={placeholderRef} placeholder={displayText} className="min-h-[100px] w-full bg-transparent pr-12 dark:bg-transparent backdrop-blur-sm" onBlur={() => {}} />
  );
}
